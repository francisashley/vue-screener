import { aF as extendTailwindMerge, ar as defineComponent, aG as computed, at as openBlock, aC as createElementBlock, aE as renderSlot, aH as normalizeClass, aI as debounce, aJ as ref, aK as onMounted, aL as normalizeStyle, ax as createBaseVNode, au as createBlock, av as withCtx, aw as createVNode, aB as createCommentVNode, aM as Fragment, aN as renderList, ay as normalizeProps, aO as guardReactiveProps, aA as createTextVNode, aP as watch, aD as toDisplayString, aQ as v4, aR as orderBy } from "./vendor-D_B1VaJJ.js";
      ...
      createVNode($setup["TableHead"], {
        ...
        default: withCtx(() => [
          ...
          (openBlock(true), createElementBlock(
            Fragment,
            null,
            renderList($props.screener.visibleColumnDefs.value, (column, _i) => {
              var _a, _b;
          ...
          return openBlock(), createBlock($setup["TableRow"], {
            ...
            default: withCtx(() => [
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList($props.screener.visibleColumnDefs.value, (column, _j) => {
                  var _a;
                  return renderSlot(_ctx.$slots, "data", {
                    ...
                    return [
                      createVNode($setup["TableCell"], {
                        ...
                        _: 2
                        /* DYNAMIC */
                      }, 1032, ["column", "value", "is-first", "is-last", "is-sticky", "is-sticky-overlapping", "item", "ui", "highlight-matches", "search-text"])
                    ];
                  });
                }),
                128
  ...
  return openBlock(), createElementBlock(
    ...
    [
      $setup.view === "table" ? (openBlock(), createBlock($setup["TableView"], {
        ...
        _: 3
        /* FORWARDED */
      }, 8, ["screener", "ui", "style"])) : $setup.view === "no-data" ? (openBlock(), createBlock($setup["NoDataView"], {
        key: 1,
        ui: (_a = $setup.ui) == null ? void 0 : _a.noDataView,
        style: normalizeStyle({ height: $props.screener.preferences.value.height })
      }, {
        default: withCtx(() => [
        ...
        key: 2,
        ui: (_b = $setup.ui) == null ? void 0 : _b.badDataView,
        style: normalizeStyle({ height: $props.screener.preferences.value.height })
      }, {
        default: withCtx(() => [
          createCommentVNode(" eslint-disable-line "),
...
function search(options) {
  ...
  const testExcludeFilters = (filters, item) => {
    return filters.some(([field, value]) => {
      if (item.data[field]) {
        return testCriteria(item.data[field].value, value, {
          matchCase,
          matchWord: true,
          matchRegex
        });
  ...
  const testIncludeFilters = (filters, item) => {
...
const useScreener = (inputData, options = {}) => {
  ...
  const columnDefs = computed(() => {
    ...
    const columns = fields.map((field, i) => {
      var _a;
      const inputColumn = ((_a = options.columnDefs) == null ? void 0 : _a[field]) ?? {};
  ...
  const actions = {
    ...
    sort: (field) => {
      const fieldConfig = columnDefs.value.find((columnDefs2) => columnDefs2.field === field);
      searchQuery.value.sortDirection = searchQuery.value.sortField === field ? searchQuery.value.sortDirection === "desc" ? "asc" : "desc" : (fieldConfig == null ? void 0 : fieldConfig.defaultSortDirection) || searchQuery.value.sortDirection;
  ...
  return {
    ...
    columnDefs,
    // columnDefs (field, label, width, isFirst, isLast, isSticky, isSortable, defaultSortDirection)
    visibleColumnDefs,
    // the visible columnDefs
    actions
    // actions
  };
};
