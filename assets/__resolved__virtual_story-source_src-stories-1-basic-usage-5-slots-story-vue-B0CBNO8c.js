const __resolved__virtual_storySource_srcStories1BasicUsage5SlotsStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcStories1BasicUsage5SlotsStoryVue as default
};
