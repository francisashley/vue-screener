const __resolved__virtual_storySource_srcStories1BasicUsage5DisableDataTypeHighlightingStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcStories1BasicUsage5DisableDataTypeHighlightingStoryVue as default
};
