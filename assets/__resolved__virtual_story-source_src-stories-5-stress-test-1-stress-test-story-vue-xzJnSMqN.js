const __resolved__virtual_storySource_srcStories5StressTest1StressTestStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcStories5StressTest1StressTestStoryVue as default
};
