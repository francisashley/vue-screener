  ...
  return openBlock(true), createElementBlock(
    ...
    renderList($props.screener.items.value, (item, i) => {
      ...
      return openBlock(), createBlock(resolveDynamicComponent($setup.props.screener.rowConfig.value.link ? $setup.resolveComponent("router-link") : "div"), {
        href: $setup.props.screener.rowConfig.value.link ? ((_b = (_a = $setup.props.screener.rowConfig.value).getLink) == null ? void 0 : _b.call(_a, item)) ?? "#" : void 0,
        style: normalizeStyle($setup.rowStyle),
        key: i,
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    pick: { type: Array, required: false },
    omit: { type: Array, required: false },
...
function _sfc_render$6(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    ...
    [
      $setup.view === "bad-data" ? (openBlock(), createElementBlock("div", _hoisted_1$6, " Invalid data provided. Please provide an array of objects or an array of arrays. ")) : createCommentVNode("v-if", true),
      $setup.view === "no-data" ? (openBlock(), createElementBlock("p", _hoisted_2$4, "No data provided")) : createCommentVNode("v-if", true),
...
const useScreener = (defaultData, options = {}) => {
  ...
  const omit = ref([]);
  const rowConfig = ref({
    link: ((_a = options.rows) == null ? void 0 : _a.link) ?? false,
    getLink: (_b = options.rows) == null ? void 0 : _b.getLink
  });
