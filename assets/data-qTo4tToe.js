...
function _sfc_render$b(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    {
      ...
      style: normalizeStyle({ height: $props.screener.preferences.value.contentHeight })
    },
    [
...
const useVueScreener = (inputData, options = {}) => {
  ...
  const searchQuery = ref({
    ...
    // Current page number
    rowsPerPage: options.defaultRowsPerPage ?? 10,
  ...
  const sortedRows = computed(() => {
    ...
    const invertSort = _sortField && options.columns ? (_a = options.columns[_sortField]) == null ? void 0 : _a.invertSort : void 0;
