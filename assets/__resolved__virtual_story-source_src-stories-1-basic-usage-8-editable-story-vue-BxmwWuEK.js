const __resolved__virtual_storySource_srcStories1BasicUsage8EditableStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcStories1BasicUsage8EditableStoryVue as default
};
