const __resolved__virtual_storySource_srcStories3Theming1SpaceStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcStories3Theming1SpaceStoryVue as default
};
