              ...
              return renderSlot(_ctx.$slots, "head", {
                ...
                return [
                  createVNode($setup["TableCell"], {
                    ...
                    _: 2
                    /* DYNAMIC */
                  }, 1032, ["value", "is-first", "is-last", "is-sticky", "is-sticky-overlapping", "ui", "class", "onClick"])
                ];
              });
            }),
            128
...
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const uiDefaults = {
      ...
      textareaClass: "vsc-absolute vsc-top-0 vsc-left-0 vsc-min-w-full vsc-w-fit vsc-min-h-full vsc-outline-none vsc-z-50",
      // eslint-disable-line
      buttonClass: "vsc-absolute vsc-w-full vsc-h-full vsc-cursor-default vsc-outline-none vsc-text-start vsc-px-1 vsc-whitespace-nowrap vsc-overflow-hidden vsc-text-zinc-200",
      // eslint-disable-line
    ...
    [
      !$setup.isEditing ? (openBlock(), createElementBlock(
        "button",
        {
          ...
          onDblclick: _cache[1] || (_cache[1] = ($event) => $setup.isEditing = true)
        },
        toDisplayString($setup.stagedValue),
        35
        /* TEXT, CLASS, NEED_HYDRATION */
      )) : (openBlock(), createBlock($setup["UiTextarea"], {
        key: 1,
...
const _sfc_main$e = {};
const _hoisted_1$7 = { class: "vsc-relative vsc-flex vsc-border-b vsc-border-zinc-700 last:vsc-border-b-0 vsc-w-fit" };
...
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, uiDefaults, ui, activeCell, actions, SpreadsheetCell, SpreadsheetRow };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function _sfc_render$d(_ctx, _cache, $props, $setup, $data, $options) {
  return $props.screener.dimensions ? (openBlock(), createElementBlock("div", {
    ...
    class: "vsc-border vsc-border-zinc-700"
  }, [
