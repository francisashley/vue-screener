const __vite__fileDeps=["assets/1-basic-usage.story-BnKvRvVD.js","assets/vendor-DC0MkHh5.js","assets/VueScreener-Zb5Ngo-L.js","assets/data-BnlYeNVr.js","assets/mix-objects-data-D5HdiZTi.js","assets/2-configure-columns.story-BIU1unpk.js","assets/3-custom-cells.story-DEG014d8.js","assets/4-stress-test.story-Brz4EGf1.js","assets/HomeView.vue-DYZl6HWN.js","assets/story-B_pI0tCH.js","assets/StoryView.vue-DK6utngX.js","assets/MobileOverlay.vue2-DLWkvdeZ.js","assets/BaseEmpty.vue-Y62W6guG.js","assets/state-CCVhjxB5.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
import { Q as defineAsyncComponent, R as createRouter, S as createWebHistory, U as createWebHashHistory, V as useDark, W as useToggle, k as watch, X as markRaw, E as reactive, d as defineComponent, r as ref, Y as watchEffect, o as openBlock, q as createBlock, Z as mergeProps, _ as resolveDynamicComponent, h as createCommentVNode } from "./vendor-DC0MkHh5.js";
...
const Comp0 = defineAsyncComponent(() => __vitePreload(() => import("./1-basic-usage.story-BnKvRvVD.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0));
const Comp1 = defineAsyncComponent(() => __vitePreload(() => import("./2-configure-columns.story-BIU1unpk.js"), true ? __vite__mapDeps([5,1,2,3,4]) : void 0));
const Comp2 = defineAsyncComponent(() => __vitePreload(() => import("./3-custom-cells.story-DEG014d8.js"), true ? __vite__mapDeps([6,1,2,3]) : void 0));
const Comp3 = defineAsyncComponent(() => __vitePreload(() => import("./4-stress-test.story-Brz4EGf1.js"), true ? __vite__mapDeps([7,1,2]) : void 0));
let files = [
  ...
  routes: [
    {
      path: "/",
      name: "home",
      component: () => __vitePreload(() => import("./HomeView.vue-DYZl6HWN.js"), true ? __vite__mapDeps([8,9,1]) : void 0)
    },
    {
      path: "/story/:storyId",
      name: "story",
      component: () => __vitePreload(() => import("./StoryView.vue-DK6utngX.js"), true ? __vite__mapDeps([10,1,9,11,12,13]) : void 0)
    }
  ]
});
...
const clientSupportPlugins = {
  "vanilla": () => __vitePreload(() => import("./vendor-DC0MkHh5.js").then((n) => n.aW), true ? [] : void 0),
  "vue3": () => __vitePreload(() => import("./vendor-DC0MkHh5.js").then((n) => n.aX), true ? [] : void 0)
};
const __default__ = {
  inheritAttrs: false
};
