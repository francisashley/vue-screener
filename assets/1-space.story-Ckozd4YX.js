import { ar as defineComponent, as as resolveComponent, at as openBlock, au as createBlock, av as withCtx, ax as createBaseVNode, aw as createVNode, aC as createElementBlock, aD as renderList, aE as Fragment } from "./vendor-5jMRr-pA.js";
import { _ as _export_sfc, u as useVueScreener, V as VueScreener, c as VueScreenerSearch, d as VueScreenerSearchOptions, e as VueScreenerPagination, f as VueScreenerPaginationRowsPerPage, g as VueScreenerPaginationResults, h as VueScreenerPaginationButtons, i as VueScreenerTableView, j as VueScreenerTableHead, b as VueScreenerTableHeadCell, k as VueScreenerTableRow, a as VueScreenerTableCell } from "./VueScreenerSearchOptions-DiE3bW7o.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    }, get VueScreenerTableView() {
      return VueScreenerTableView;
    ...
    default: withCtx(() => [
      createBaseVNode("div", _hoisted_1, [
        ...
        createVNode($setup["VueScreener"], {
          ...
          default: withCtx(({ screener: internalScreener }) => [
            createVNode($setup["VueScreenerTableView"], { screener: internalScreener }, {
              default: withCtx(() => [
        ...
        createVNode($setup["VueScreenerPagination"], { screener: $setup.screener }, {
          default: withCtx(() => [
            createVNode($setup["VueScreenerPaginationResults"], {
              total: $setup.screener.queriedRows.value.length ?? 0,
            ...
            createVNode($setup["VueScreenerPaginationButtons"], {
              total: $setup.screener.queriedRows.value.length,
              "per-page": $setup.screener.searchQuery.value.rowsPerPage,
              "current-page": $setup.screener.searchQuery.value.page,
