const __resolved__virtual_storySource_srcStories2ConfigureColumns9ColumnTooltipsStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcStories2ConfigureColumns9ColumnTooltipsStoryVue as default
};
