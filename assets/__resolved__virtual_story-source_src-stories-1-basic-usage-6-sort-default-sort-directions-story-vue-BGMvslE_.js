const __resolved__virtual_storySource_srcStories1BasicUsage6SortDefaultSortDirectionsStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcStories1BasicUsage6SortDefaultSortDirectionsStoryVue as default
};
