import { aJ as ref, aK as onMounted, aL as onUnmounted, ar as defineComponent, aF as twMerge$1, at as openBlock, aC as createElementBlock, aH as renderSlot, aI as normalizeClass, aM as extendTailwindMerge, ax as createBaseVNode, aN as ArrowDown, au as createBlock, aO as computed, av as withCtx, aB as createCommentVNode, aA as createTextVNode, aG as toDisplayString, aP as debounce, aQ as watchEffect, aR as normalizeStyle, aw as createVNode, aE as Fragment, aD as renderList, aS as v4, aT as orderBy, aU as watch, aV as CaseSensitive, aW as Regex, aX as WholeWord } from "./vendor-BgGZQa4R.js";
...
function _sfc_render$j(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createBlock($setup["ArrowDown"], {
    class: normalizeClass([
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, toggleOption, get CaseSensitiveIcon() {
      return CaseSensitive;
    }, get RegexIcon() {
      return Regex;
    }, get WholeWordIcon() {
      return WholeWord;
    }, ToggleButtonGroup, ToggleButton, get twMerge() {
      return twMerge;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  ...
  return openBlock(), createBlock($setup["ToggleButtonGroup"], null, {
    default: withCtx(() => [
      createVNode($setup["ToggleButton"], {
        ...
        default: withCtx(() => [
          createVNode($setup["CaseSensitiveIcon"], {
      ...
      createVNode($setup["ToggleButton"], {
        ...
        default: withCtx(() => [
          createVNode($setup["WholeWordIcon"], {
            class: normalizeClass($setup.twMerge("vsc-w-4 vsc-h-4", $setup.props.iconClass))
          }, null, 8, ["class"])
        ]),
        _: 1
